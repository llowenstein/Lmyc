...
namespace LmycWeb.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            ViewData["BoatName"] = new SelectList(_context.Boat, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("ReservationId,CreatedBy,StartTime,EndTime,BoatName")] Reservation reservation)
        {
            ...
            ViewData["BoatName"] = new SelectList(_context.Boat, "BoatId", "BoatId", reservation.BoatName);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservationId,CreatedBy,StartTime,EndTime,BoatName")] Reservation reservation)
        {
